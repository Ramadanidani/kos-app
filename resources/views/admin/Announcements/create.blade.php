    ...
    <div class="content-card">
        <div class="content-card-header">
            <span style="font-weight:600; font-size:.95rem;">
                <i class="bi bi-megaphone me-2" style="color:var(--accent);"></i>Pengumuman Baru
            </span>
        </div>
            ...
            <form method="POST" action="{{ route('admin.announcements.store') }}">
                ...
                <div style="margin-bottom:1.1rem;">
                    ...
                    <input type="text" name="title" class="form-mk"
                           value="{{ old('title') }}"
                           placeholder="Contoh: Jadwal Pembersihan Bersama"
                           required>
                    @error('title')
                ...
                <div style="margin-bottom:1.1rem;">
                    ...
                    <textarea name="content" class="form-mk" rows="6"
                              ...
                              required style="resize:vertical;">{{ old('content') }}</textarea>
                    @error('content')
                        <div style="color:#f87171; font-size:.78rem; margin-top:.3rem;">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div style="margin-bottom:1.75rem; display:flex; align-items:center; gap:12px;">
                    ...
                    <div>
                        ...
                        <div style="color:var(--text-muted); font-size:.75rem;">Jika aktif, pengumuman akan tampil ke seluruh penghuni</div>
                    </div>
                </div>
